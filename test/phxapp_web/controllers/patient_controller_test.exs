defmodule PhxappWeb.PatientControllerTest do
  use PhxappWeb.ConnCase

  alias Phxapp.PatientData

  @create_attrs %{birth_date: ~D[2010-04-17], first_name: "some first_name", last_name: "some last_name", ssn4: "some ssn4"}
  ...
  def fixture(:patient) do
    {:ok, patient} = PatientData.create_patient(@create_attrs)
    patient
  end
